...
module('Integration | Component | outgoing-cloud-deliveries', function(hooks) {
  setupRenderingTest(hooks);

  test('it renders', async function(assert) {
    const model = [];
    this.set('model', model);
    await render(hbs`{{outgoing-cloud-deliveries model=model}}`);
