...
module('Integration | Component | share-users-table', function(hooks) {
  ...
  test('it renders with message when empty', async function(assert) {
    ...
    assert.equal($('.share-users-table-no-users-message').text().trim(), "No users selected");
  });
  ...
  test('it renders without message when has content', async function(assert) {
    ...
    assert.equal($('.share-users-table-no-users-message').text().trim(), "");
  });
  ...
  test('it renders users that can be deleted', async function(assert) {
    ...
    assert.equal($('.share-users-table-tbody td').eq(0).text().trim(), "John Smith");
    assert.equal($('.share-users-table-tbody td').eq(1).text().trim(), "john");
    assert.equal($('.share-users-table-tbody td').eq(2).text().trim(), "john@smith.com");
    assert.equal($('.share-users-table-tbody td button').text().trim(), "Remove");

    $('.share-users-table-tbody td button').click();
  });
  ...
  test('it runs a method when add user is clicked', async function(assert) {
    ...
    assert.equal($('.share-users-table-footer button').text().trim(), "Add User");
    $('.share-users-table-footer button').click();
  });
});
